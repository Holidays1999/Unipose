...
def parse_arguments():
    ...
    parser.add_argument("--eval_while_train", type=ast.literal_eval, default=False, help="whether eval while train")
    ...
    parser.add_argument("--backbone", help="backbone of Unipose", type=str, default="ResNet101")
    ...
    parser.add_argument("--lr_gamma", default=0.333, type=float, help="multistep multiplier")
...
def get_config():
    ...
    args.heatmap_h = round(args.height / args.stride)
    args.heatmap_w = round(args.width / args.stride)
